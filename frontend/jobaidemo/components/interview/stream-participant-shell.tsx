...
export const STREAM_VIDEO_BOX_CLASS =
  "h-[280px] min-h-[280px] w-full shrink-0 overflow-hidden rounded-xl border border-white/50 bg-[#d0d6e0]";

export const STREAM_CARD_FOOTER_CLASS = "flex min-h-[176px] w-full shrink-0 flex-col justify-end gap-2";
...
export function StreamParticipantShell({
  ...
  return (
    <section className="flex h-full min-h-0 w-full flex-col items-center gap-3">
      <h3 className="h-9 shrink-0 text-center text-[30px] font-medium leading-none text-slate-600">{title}</h3>
